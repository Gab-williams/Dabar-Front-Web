                    ...
                    <div className="tgmobile__menu-outer">
                        <ul className="navigation">
                            {categoryMenux.map((item,i)=>{
                                return <li style={{ cursor:"pointer" }}  className="active menu-item-has-children" onClick={()=>handleLinkPagex(item.title)} key={i}> <a onClick={()=>handleLinkPagex(item.title)}  >{item.title}</a> </li>
