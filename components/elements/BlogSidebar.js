      ...
      if (selectedx === 'GB') {
       ...
       let ansfinancex =  await changlangx("EN", financex.innerText)
        let ansculture =  await changlangx("EN", culture.innerText)
         ...
         categx.innerHTML = "Trending Category"
         businessx.innerHTML = "Business Insights"
         technologyx.innerHTML = "Technology Trends"
         financex.innerHTML =  "Marketing & Finance"
         culture.innerHTML = "Workplace & Culture"
         productivityx.innerHTML = "Productivity & Innovation"
         eventsx.innerHTML = "Multimedia & Events"
         opinions.innerHTML = "Opinions & Editorials"
